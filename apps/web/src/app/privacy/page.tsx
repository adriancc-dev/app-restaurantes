  ...
  return (
    <div className="min-h-screen bg-[#051424]">
      <div className="max-w-3xl mx-auto px-4 py-12">
        <Link href="/" className="text-sm text-primary-400 hover:underline">← Volver al inicio</Link>

        <h1 className="text-3xl font-bold text-white mt-6 mb-2">Política de Privacidad</h1>
        <p className="text-sm text-[#908fa0] mb-10">Versión: abril 2026 · Última actualización: 28 de abril de 2026</p>

        <div className="prose prose-gray max-w-none space-y-8 text-[#d4e4fa]">
          ...
          <section>
            <h2 className="text-xl font-semibold text-white">2. Datos personales que recopilamos</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white">3. Finalidad y base jurídica del tratamiento</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white">4. Destinatarios de los datos</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white">5. Transferencias internacionales</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white">6. Plazo de conservación</h2>
            <p>
          ...
          <section>
            ...
            <p>
              ...
              <a href="https://www.aepd.es" target="_blank" rel="noreferrer" className="text-primary-400 hover:underline">
          ...
          <section>
            <h2 className="text-xl font-semibold text-white">9. Seguridad</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white">10. Modificaciones</h2>
            <p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 flex gap-4 text-sm">
          <Link href="/terms" className="text-primary-400 hover:underline">Términos de Uso</Link>
          <Link href="/" className="text-[#908fa0] hover:underline">Volver al inicio</Link>
        </div>
      </div>
    </div>
  )
