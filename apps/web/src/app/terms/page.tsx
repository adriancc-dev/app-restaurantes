  ...
  return (
    <div className="min-h-screen bg-[#051424]">
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <h1 className="text-3xl font-bold text-white mt-6 mb-2">Términos y Condiciones de Uso</h1>
        ...
        <div className="prose prose-gray max-w-none space-y-8 text-[#d4e4fa]">
          ...
          <section>
            <h2 className="text-xl font-semibold text-white">3. Condiciones de acceso y uso</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white">4. Cuentas de restaurante y suscripción</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white">5. Reservas</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white">6. Responsabilidad</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white">9. Ley aplicable y jurisdicción</h2>
            <p>
