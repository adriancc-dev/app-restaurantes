  ...
  return (
    <div className="space-y-16 pb-16">
      ...
      <section className="flex flex-col items-center text-center pt-6">
        <p className="text-[#908fa0] text-xs font-semibold mb-3 tracking-widest uppercase">
          Hola, {firstName}
        </p>
        <h1 className="text-4xl sm:text-5xl font-bold text-white leading-tight tracking-tight max-w-2xl mb-8">
        ...
        <form action="/restaurants" method="GET" className="w-full max-w-2xl">
          <div className="relative group">
            ...
            <div className="relative flex items-center bg-[#0d1c2d] border border-[#464554] rounded-full px-6 py-4 shadow-xl focus-within:border-primary-500/70 transition-all duration-300 gap-4">
              <svg
      ...
      <section>
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold text-white tracking-tight">Explorar por Localidad</h2>
          <Link
            href="/restaurants"
      ...
      {featuredRestaurants && featuredRestaurants.length > 0 && (
        <section>
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold text-white tracking-tight">Restaurantes Destacados</h2>
            <Link
              href="/restaurants"
              className="text-primary-400 text-xs font-semibold tracking-widest uppercase hover:underline"
            >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {featuredRestaurants.map((restaurant) => (
              <Link
                ...
                className="bg-[#0d1c2d] border border-white/10 rounded-xl overflow-hidden flex flex-col group transition-all duration-300 hover:shadow-2xl hover:shadow-primary-500/10 hover:border-primary-500/30"
              >
                ...
                <div className="p-4 flex flex-col flex-grow">
                  <div className="mb-3 flex-grow">
                    ...
                    {restaurant.description && (
                      <p className="text-xs text-[#464554] mt-1 line-clamp-2">{restaurant.description}</p>
                    )}
                  </div>
      ...
      <section className="grid sm:grid-cols-2 gap-4">
        <Link
          href="/calendar"
          className="bg-[#0d1c2d] border border-white/10 rounded-xl p-6 flex items-center gap-4 hover:border-primary-500/40 transition-all duration-300 group"
        >
          <div className="w-14 h-14 bg-primary-500/10 border border-primary-500/20 rounded-xl flex items-center justify-center text-2xl shrink-0">
            📅
          </div>
          <div>
